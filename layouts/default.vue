...
<style>
  ...
  *,
  ...
  .WorkPreview-title h1 {
    font-family: GothamNarrow-Medium, -apple-system, " .SFNSText-Regular", "San Francisco"
      , "Roboto"
      , "Segoe UI"
      , "Helvetica Neue"
      , "Lucida Grande"
  ...
  .is-desktop .Work-scrollTransition.is-active {
    ...
    transition: opacity .6s cubic-bezier(.23, 1, .32, 1), transform .6s cubic-bezier(.23,
      1, .32, 1);
  ...
  .Timeline-arrow {
    ...
    transition: opacity .4s cubic-bezier(.23, 1, .32, 1), transform .4s cubic-bezier(.23,
      1, .32, 1)
  }
